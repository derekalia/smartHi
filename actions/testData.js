const Ids =[
    'qBbqrGWzWBgN93SRZN5j4nG3ZNg2',
    'BXNmGWvwATY2c9E2Iyhq3JB5Q6k1',
    'EzcOagJh1Pg9c6vfWDkw29nfWkZ2',
    'USDlO0Ec8NYS43s150H2M2DsIfc2',
    'YoEKLo8MMUWIbDsyukcJw9UW09H2'];


const TestUsers = [
{   id:'qBbqrGWzWBgN93SRZN5j4nG3ZNg2',
    name:'Hash Tag',
    address:'Seattle, WA',
    score:'100000',
    follower:[Ids[1],Ids[2],Ids[3],Ids[4]],
    following:[Ids[2],Ids[3]],
    fpid:['4','5'],
    pid:['0','1'],
    rid:['1','2'],
    rpid:['1','2','3'],
},
{   id:'BXNmGWvwATY2c9E2Iyhq3JB5Q6k1',
    name:'Cookie Monster',
    address:'Seattle, WA',
    score:'100000',
    follower:[Ids[2],Ids[3],Ids[4]],
    following:[Ids[2],Ids[3]],
    fpid:['4','0'],
    pid:['2','1'],
    rid:['3','4'],
...
{   id:'EzcOagJh1Pg9c6vfWDkw29nfWkZ2',
    name:'VW Bug',
    address:'Redmond, WA',
    score:'100000',
    follower:[Ids[1],Ids[3],Ids[4]],
    following:[Ids[1],Ids[3]],
    fpid:['0','1'],
    pid:['1','4'],
    rid:['0','1','2'],
    rpid:['2','4','5'],
},
{   id:'USDlO0Ec8NYS43s150H2M2DsIfc2',
    name:'330 BMW',
    address:'Redmond, WA',
    score:'100000',
    follower:[Ids[2],Ids[3]],
    following:[Ids[2],Ids[3]],
    fpid:['3','4','5','6'],
    pid:['2','4'],
    rid:['0','1','2'],
...
{   id:'YoEKLo8MMUWIbDsyukcJw9UW09H2',
    name:'X5 BMW',
    address:'Issaquah, WA',
    score:'100000',
    follower:[Ids[3],Ids[4]],
    following:[Ids[3],Ids[4]],
    fpid:['0','1','5','6'],
    pid:['2','3'],
    rid:['0','1','2'],
    rpid:['0','2','4'],
...
{   id:'0',
    ...
    follower:[Ids[0],Ids[3],Ids[4]],
    following:[Ids[1],Ids[2],Ids[4]],
    pid:['0','1','2','3'],},
...
{   id:'1',
    ...
    ratingCount: 200,
    rid:['0','1','4','5'], //Producer 0 is a special case and used to test producer login
    follower:[Ids[0],Ids[1],Ids[2]],
    following:[Ids[0],Ids[3],Ids[4]],
    pid:['4','5'],},
