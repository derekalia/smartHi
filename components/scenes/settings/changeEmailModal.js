...
class ChangeEmailModal extends Component {
    ...
    _changeName() {
        //BatsFix. change email function called here. this should update the profile also
    }
    render() {
        return(
        <HerbyModal show={this.props.visible} onClose={()=>this.props.onClose()}>
            <View style={{backgroundColor:'white',alignSelf:'center',alignItems:'center',justifyContent:'center'}}>
                <HerbyInput style={{marginLeft:20,marginRight:20}} value='Email to use' isCentered={true} onChange={(t)=>this._setName(t)}/>
